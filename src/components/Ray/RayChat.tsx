...
const RayChat = ({
  ...
  return <div className="bg-background/95 backdrop-blur-xl border border-border rounded-3xl shadow-2xl overflow-hidden h-[500px] flex flex-col">
      {/* Header */}
      ...
      <div className="p-4 border-t border-border/50">
        <div className="flex gap-2">
          <Input value={input} onChange={e => setInput(e.target.value)} onKeyPress={e => e.key === "Enter" && sendMessage()} placeholder="Ask Ray anything..." className="rounded-full" disabled={isLoading} />
